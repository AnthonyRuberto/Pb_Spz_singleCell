...
mca.ss2<-readRDS("output/MS/4_MCA_SS2_seurat.rds")
...
saveRDS(Pb.integrated.MCA.10X, "output/MS/5_Pb_integrated_MCA_10X.rds")
saveRDS(Pb.integrated.10X.only, "output/MS/5_Pb_integrated_10X_only.rds")
